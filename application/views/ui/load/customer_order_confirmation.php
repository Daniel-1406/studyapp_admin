...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Thank you for your order! We've successfully received your payment proof for Order ID <b>#<?= html_escape($order->id) ?></b>.</p>
            <p>Your order is now in the <b>"Pending Payment Verification"</b> status. We'll verify your deposit and update you shortly. The admin will get back to you within 24 hours.</p>
