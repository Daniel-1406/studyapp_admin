...
.biolife-cart-info .icon-qty-combine .qty{
    background-color:<?php echo isset($colour) ? htmlspecialchars($colour) : '#ff9702'; ?>;
}
...
.nice-select .option.selected.focus{
    ...
    color: <?php echo isset($colour) ? htmlspecialchars($colour) : '#ff9702'; ?>;
}
...
.biolife-cart-info .minicart-block .cart-inner{
    border-top-color: <?php echo isset($colour) ? htmlspecialchars($colour) : '#ff9702'; ?>;
}
.btn.btn-thin:hover,
.testml-elem-2 .avata,
...
.sidebar .wgt-content .check-list li a:hover::before{
	border-color: <?php echo isset($colour) ? htmlspecialchars($colour) : '#ff9702'; ?>;
}
</style>